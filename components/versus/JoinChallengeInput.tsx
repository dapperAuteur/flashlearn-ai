    ...
    <form onSubmit={handleSubmit} className="w-full">
      <div className="flex items-center gap-2">
        <input
          ...
          className="flex-1 px-4 py-2.5 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 rounded-lg text-sm text-gray-800 dark:text-gray-200 placeholder-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent font-mono tracking-wide"
          disabled={isLoading}
        />
        <span id="join-code-hint" className="sr-only">Enter challenge code like VS-A3K9M2</span>
        <button
          type="submit"
