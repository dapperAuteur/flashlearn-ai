      ...
      try {
        ...
        if (results.length > 0) {
          fetchedFlashcards = results.map(card => ({
            ...
            frontImageAlt: card.front_image_alt || undefined,
            backImageAlt: card.back_image_alt || undefined,
            frontVideo: card.front_video || undefined,
            backVideo: card.back_video || undefined,
            frontVideoAlt: card.front_video_alt || undefined,
            backVideoAlt: card.back_video_alt || undefined,
        ...
        try {
          ...
          if (response.ok) {
            ...
            fetchedFlashcards = apiFlashcards.map((card: Record<string, unknown>) => ({
              ...
              frontImageAlt: (card.frontImageAlt as string) || undefined,
              backImageAlt: (card.backImageAlt as string) || undefined,
              frontVideo: (card.frontVideo as string) || undefined,
              backVideo: (card.backVideo as string) || undefined,
              frontVideoAlt: (card.frontVideoAlt as string) || undefined,
              backVideoAlt: (card.backVideoAlt as string) || undefined,
