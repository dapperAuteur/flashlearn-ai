    ...
    schemas: {
      Flashcard: {
        ...
        properties: {
          ...
          options: {
            type: 'array' as const,
            description: 'Optional authored multiple-choice options. When present, multiple-choice study serves these and scores against correctOptionId instead of generating distractors.',
            items: { type: 'object' as const, properties: { id: { type: 'string' as const }, text: { type: 'string' as const } }, required: ['id', 'text'] },
            minItems: 2,
          },
          ...
          frontVideo: { type: 'string' as const, format: 'uri' as const, description: 'Optional https video URL on the front; rendered as a player in study.' },
          backVideo: { type: 'string' as const, format: 'uri' as const, description: 'Optional https video URL on the back.' },
          frontVideoAlt: { type: 'string' as const, description: 'Screen-reader label for the front video.' },
          backVideoAlt: { type: 'string' as const, description: 'Screen-reader label for the back video.' },
        },
        required: ['front', 'back'],
      },
      FlashcardSet: {
                  ...
                  flashcards: {
                    ...
                    items: {
                      ...
                      properties: {
                        ...
                        options: {
                          type: 'array' as const,
                          description: 'Optional authored multiple-choice options.',
                          items: { type: 'object' as const, properties: { id: { type: 'string' as const }, text: { type: 'string' as const } }, required: ['id', 'text'] },
                          minItems: 2,
                        },
                        ...
                        frontVideo: { type: 'string' as const, format: 'uri' as const, description: 'Optional https video URL on the front.' },
                        backVideo: { type: 'string' as const, format: 'uri' as const, description: 'Optional https video URL on the back.' },
                        frontVideoAlt: { type: 'string' as const, description: 'Alt text for the front video.' },
                        backVideoAlt: { type: 'string' as const, description: 'Alt text for the back video.' },
                      },
                      required: ['front', 'back'],
                    },
                    minItems: 1,
