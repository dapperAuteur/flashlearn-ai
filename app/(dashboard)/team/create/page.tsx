      ...
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        <div>
          ...
          <p className="text-sm text-gray-600">
            Set up a new team to study and collaborate with others.
          </p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5" noValidate>
            ...
            <div>
              <label htmlFor="team-name" className="block text-sm font-medium text-gray-700 mb-1">
                Team Name <span className="text-red-500" aria-hidden="true">*</span>
              </label>
              <input
                id="team-name"
                type="text"
            ...
            <div>
              ...
              <textarea
                ...
                maxLength={500}
                rows={3}
                placeholder="Describe what your team is about (optional)"
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-gray-500">
                Separate tags with commas to help others find your team.
              </p>
            </div>
