...
export default function GenerationGuidePage() {
  ...
  "correctOptionId": "a"
        ...
        <ul className="list-disc pl-6 text-gray-600 space-y-1 mt-3 text-sm">
          ...
          <li><strong>Media.</strong> Set <code className="bg-gray-100 px-1 rounded text-xs">frontImage</code>/<code className="bg-gray-100 px-1 rounded text-xs">backImage</code> to an <code className="bg-gray-100 px-1 rounded text-xs">https</code> URL and always include <code className="bg-gray-100 px-1 rounded text-xs">frontImageAlt</code>/<code className="bg-gray-100 px-1 rounded text-xs">backImageAlt</code> for screen readers.</li>
