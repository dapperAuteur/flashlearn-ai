...
const releases: Release[] = [
  ...
  },
  {
    ...
    items: [
      ...
      'The classroom page now has the roster: add a student by name, see which accounts are yours to look after, mint a fresh claim code, and remove someone from the class. A managed student shows no email address, because the one it holds is a placeholder that cannot receive mail.',
      'Start session on a roster row opens study with that student already chosen, and says whose account it lands on before a set is picked. Starting from a set still works the way it did, and studying as yourself is still what happens unless something asks otherwise.',
      'A new /claim page is where a student turns the account into their own. It asks their age first, then the code, an email address, and a password with the same rules as signup.',
